...
:: Long form of the command (This might not still be correct.  Recopy from terminal if needed)
:: TestRig.exe -s l [l -lab "C:\Documents and Settings\sketcher\My Documents\sketch\Data\Domains\labelMapFiles\ftree-nlt.txt" -crf "C:\Documents and Settings\sketcher\My Documents\sketch\Code\Recognition\RunCRF\russell_tests\russell.tcrf" "C:\Documents and Settings\sketcher\My Documents\sketch\Data\Domains\domainIndexFiles\ftree.txt" -printgraphs "C:\Documents and Settings\sketcher\My Documents\sketch\Code\Recognition\RunCRF\russell_tests\graphMagics"] -d "C:\Documents and Settings\sketcher\My Documents\sketch\Code\Recognition\RunCRF\russell_tests\labeledSketches"